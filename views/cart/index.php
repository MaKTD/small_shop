                ...
                <div class="col-md-4">
                    <ul class="category-menu">
                        <?php foreach ($category as $categoryName): ?>
                            <a id="<?php if ($categoryId == $categoryName['id']) echo 'category-menu-active'?>" 
                                href="/category/<?php echo $categoryName['id'] ?>">
                                <li>
                                        ...
                                        <?php foreach ($products as $item) :?>
                                            <tr class="cart_item">
                                                <td class="product-remove">
                                                    <a title="Remove this item" class="remove" href="/cart/delete/<?php echo $item['id']?>">×</a> 
                                                </td>
                                                <td class="product-thumbnail">
                                                    <a href="/product/<?php echo $item['id'] ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo Product::getImage($item['id']); ?>"></a>
                                                </td>
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity buttons_added">
                                                        <span class="amount"><?php echo $productsInCart[$item['id']]?></span> 
                                                    </div>
                                                </td>
                                                <td class="product-subtotal">
                                                    <span class="amount"><?php echo $productsInCart[$item['id']] * $item['price']?></span> 
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Цена товаров</th>
                                            <td><span class="amount"><?php echo $totalPrice?></span></td>
                                        </tr>

                                        <tr class="shipping">
                                            <th>Доставка и упаковка</th>
                                            <td>Бесплатно</td>
                                        </tr>

                                        <tr class="order-total">
                                            <th>Цена заказа</th>
                                            <td><strong><span class="amount"><?php echo $totalPrice?></span></strong> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
